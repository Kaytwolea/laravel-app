                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <h1
                                style="margin: text-decoration: capitalize; 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Thank for creating an account with us, kindly enter
                                <b>{{ $data->verification_code }}</b> as your verification, you can
                                safely delete
                                this email.
                            </p>
                        </td>
